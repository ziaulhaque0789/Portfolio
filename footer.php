...
<footer class="bg-dark text-light pt-5 pb-4 shadow-lg">
  <div class="container">
    <div class="row gy-5">
      ...
      <div class="col-md-6">
        ...
        <ul class="list-unstyled small">
          <li class="mb-2"><i class="bi bi-envelope text-primary me-2"></i> <a href="mailto:zia@brightfuturei.com" class="text-light text-decoration-none">zia@brightfuturei.com</a></li>
          <li class="mb-2"><i class="bi bi-telephone text-primary me-2"></i> <a href="tel:+8801327227048" class="text-light text-decoration-none">+8801327227048</a></li>
          <li><i class="bi bi-geo-alt text-primary me-2"></i> Mirpur-12, Dhaka, Bangladesh</li>
        </ul>
      </div>
    ...
    <div class="text-center small text-white">
      © 2025 <strong>Ziaul Haque</strong> — All Rights Reserved | Apparel Merchandiser & Web Solutions 
    </div>
  </div>
</footer>
